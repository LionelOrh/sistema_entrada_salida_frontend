...
export class ConsultaSalaComponent{
 ...
 //Cabecera
 displayedColumns = ["idSala","numero","piso","numAlumnos","recursos","tipo","sede","estadoReserva","estado"];
 ...
 filtrar(){
  ...
  console.log(">>> varIdEstadoReserva: "+this.varIdEstadoReserva);
  ...
  this.salaService.consultarSalaComplejo(
              ...
              this.varIdTipoSala, 
              this.varIdSede,
              this.varIdEstadoReserva).subscribe(
        x => {
              this.dataSource = x;
